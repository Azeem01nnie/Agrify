...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2025 at 10:15 AM
...
INSERT INTO `animals` (`animal_id`, `cage_id`, `animal_type`, `date_of_birth`, `price`, `breedable`, `sellable`, `created_at`) VALUES
(1, 9, 'Chicken', '2025-05-14', 1200.00, 1, 0, '2025-05-11 15:06:24'),
(2, 9, 'Chicken', '2025-05-21', 500.00, 0, 1, '2025-05-11 15:11:54'),
(3, 9, 'Goat', '2025-05-12', 12.00, 1, 0, '2025-05-11 15:17:13'),
(4, 10, 'Abdu', '2025-05-05', 12300.00, 1, 1, '2025-05-15 05:17:42'),
(5, 8, 'Cow', '2025-05-20', 12000.00, 1, 1, '2025-05-15 07:42:58'),
(6, 8, 'Goat', '2025-05-15', 99999999.99, 1, 1, '2025-05-15 07:58:48'),
(7, 8, 'Ducks', '2025-05-17', 1233333.00, 1, 1, '2025-05-15 08:00:09');
...
INSERT INTO `cages` (`cage_id`, `cage_name`, `cage_desc`, `image_path`, `created_at`, `user_id`) VALUES
(1, 'test', 'test', '../uploads/1745576760_aaa.png', '2025-04-25 18:42:01', 3),
(5, 'draw.io', 'hehe', '../php/uploads/cage_680c41f6a232a0.87499536_4.png', '2025-04-26 10:16:22', 3),
(8, 'Eric', 'eric', '../php/uploads/cage_680ca06d2b97d4.58912719_474976383_1351250049105898_1895188837475773115_n.jpg', '2025-04-26 16:59:25', 4),
(9, 'Chicken Cage', 'This cage is for chickens', '../php/uploads/cage_6820b5d2092e07.03573222_james-doakes.png', '2025-05-11 22:36:02', 6),
(10, 'Bisaya Cage', '', '../php/uploads/cage_68248922113da7.92727041_474976383_1351250049105898_1895188837475773115_n.jpg', '2025-05-14 20:14:26', 6);

-- --------------------------------------------------------

--
-- Table structure for table `cages_backup`
--

CREATE TABLE `cages_backup` (
...
--
-- Dumping data for table `cages_backup`
--

INSERT INTO `cages_backup` (`cage_id`, `cage_name`, `cage_desc`, `image_path`, `created_at`, `user_id`) VALUES
(1, 'test', 'test', '../uploads/1745576760_aaa.png', '2025-04-25 18:42:01', 0),
(5, 'draw.io', 'hehe', '../php/uploads/cage_680c41f6a232a0.87499536_4.png', '2025-04-26 10:16:22', 0),
(8, 'Eric', 'eric', '../php/uploads/cage_680ca06d2b97d4.58912719_474976383_1351250049105898_1895188837475773115_n.jpg', '2025-04-26 16:59:25', 4),
(9, 'Chicken Cage', 'This cage is for chickens', '../php/uploads/cage_6820b5d2092e07.03573222_james-doakes.png', '2025-05-11 22:36:02', 6),
(10, 'Bisaya Cage', '', '../php/uploads/cage_68248922113da7.92727041_474976383_1351250049105898_1895188837475773115_n.jpg', '2025-05-14 20:14:26', 6);
...
(6, 'Lebron', 'lebron@gmail.com', '$2y$10$aaQqW2TYQop8TVpE/IEvWubwI6kW/rs/ItblZNsITWMal7HWmh/XO', 'farmer', '2025-04-21 07:21:14'),
(7, 'Eric', 'paul@gmail.com', '$2y$10$GBipabc98WQMnPhHm6WZx.cqjwL.aIjiHwfLM8W9oiKnBzeuKWMp.', 'farmer', '2025-04-23 07:50:12'),
(8, 'Jason', 'jason@email.com', '$2y$10$1QtocM5noTkuN9B/fepQw.4uuBUNpzRAftwCh8W3.F09TkNaxVDmC', 'farmer', '2025-04-26 06:11:52');
...
(5, 8, 'User Registered', '2025-04-26 06:11:52');
...
(3, 6, 'Abdu Climaco', 'Lebron Street', '2025-04-30', '09123456789', '2025-04-21 07:21:14'),
(4, 7, 'Paul Abdu', 'Labuan', '2025-04-03', '09123456789', '2025-04-23 07:50:12'),
(5, 8, 'Jason', 'jason street', '2025-04-03', '09123456789', '2025-04-26 06:11:52');
...
--
ALTER TABLE `cages`
  MODIFY `cage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `animals`
  ADD CONSTRAINT `animals_ibfk_1` FOREIGN KEY (`cage_id`) REFERENCES `cages` (`cage_id`) ON DELETE CASCADE;

--
-- Constraints for table `cages`
--
ALTER TABLE `cages`
  ADD CONSTRAINT `fk_cages_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
